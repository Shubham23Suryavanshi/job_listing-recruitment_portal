...
<?php
	...
	if($row1['degree']==$row2['degree'])
		echo "Degree required ".$row2['degree']." <img src=\"Images/tick.png\" height=\"20\" width=\"20\" ><BR>";
	else
		echo "Degree required ".$row2['degree']." <img src=\"Images/cross.png\" height=\"20\" width=\"20\" ><BR>";
	...
	if($row1['degree']==$row2['degree'] && $row1['cpi']>=$row2['cpi_e'] && $row1['year']>=$row2['year_e'] && $row1['twp']>=$row2['12p_e'] && $row1['tenp']>=$row2['10p_e']  ){
