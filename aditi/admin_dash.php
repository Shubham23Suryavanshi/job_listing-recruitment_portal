		...
		<nav class="navbar navbar-fixed-top" id="top-nav">
			<div class="container-fluid">
				...
				<ul id="list1" class="nav navbar-nav">
				   ...
				   <li class="active"><a href="vacancy.php">Open Vacancy</a></li>
       ...
       <input type=\"submit\"></input>
             ...
             if ($result->num_rows > 0) {
               ...
               while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["phone"]."</td><td>".$row["dob"]."</td><td>".$row["degree"]."</td><td> ".$row["branch"]."</td><td>".$row["year"]."</td><td>".$row["cpi"]."</td><td>".$row["tenp"]."</td><td>".$row["twp"]."</td></tr>";
                    }
              echo "</table>";
         }  else {
            echo "0 results";
